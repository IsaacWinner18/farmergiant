...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URI}/signup`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen bg-neutral-800 text-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      {toast.show && (
        <Toast
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-neutral-700 text-white py-8 px-4 shadow-custom sm:rounded-lg sm:px-10">
